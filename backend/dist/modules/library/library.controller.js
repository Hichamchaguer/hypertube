...
exports.toggleFavorite = exports.getLibrary = void 0;
...
const getLibrary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const library = yield libraryService.getUserLibrary(userId);
...
const toggleFavorite = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield libraryService.toggleFavorite(userId, movieId);
